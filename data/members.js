function getMembers() {
	return {
		eboard: [
			...
			{name: "Stephen Scmidt", title: "Vice President", year: "3/4"},
			{name: "Nicholas Buckley", title: "Treasurer", year: "1/4"},
			{name: "Christopher Kang", title: "Secretary", year: "1/4"},
		],
		minorboard: [
	...
	*/
		...
		alumni: [
			...
			{name: "Greg McLeod", year: "2012", link: "http://gregmcleod.com/"},
